...
#         "diretorio funcionarios" : {
#             "DP": os.path.join(os.path.expanduser("~"), "CONSORCIO CONCREJATOEFFICO LOTE 1", "Central de Arquivos - SERTRAS ARQUIVO PESSOAL"),
#             "QSMS": os.path.join(os.path.expanduser("~"),"CONSORCIO CONCREJATOEFFICO LOTE 1","Central de Arquivos - QSMS","000 ATUAL - OBRA 201 - SÃO GONÇALO","DOCUMENTAÇÃO DE FUNCIONÁRIOS","CONSÓRCIO"),
#         },
...
# automação = AutomaçãoDocumentos(contratos)
# automação.GerarDocumentos()